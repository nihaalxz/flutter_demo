...
class _CreateListingPageState extends State<CreateListingPage> {
  ...
  final _locationController = TextEditingController(); // Holds the location name
  ...
  /// Navigates to the map picker page and receives the selected location.
  ...
  /// Validates the form and submits the new listing with location data.
  Future<void> _submitListing() async {
    ...
    try {
      ...
      final newProduct = Product(
        ...
        image: '', // Image path is handled by the service
        categoryName: _selectedCategory!.name,
        ownerId: '', // Owner ID is handled by the backend
        ownerName: '', // Owner name is handled by the backend
        availability: true,
