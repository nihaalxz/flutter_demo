...
class _WalletPageState extends State<WalletPage> {
  ...
  /// ✅ Shows a dialog to handle withdrawal requests.
        ...
        return AlertDialog(
          ...
          content: Form(
            ...
            child: Column(
              ...
              children: [
                Text(
                    'Withdrawable Balance: ${NumberFormat.currency(locale: 'en_IN', symbol: '₹').format(walletDetails.withdrawableBalance)}'),
          ...
          children: [
            ...
            Text(
              NumberFormat.currency(
                      locale: 'en_IN', symbol: '₹')
                  .format(walletDetails.withdrawableBalance),
      ...
      delegate: SliverChildBuilderDelegate(
        (context, index) {
          ...
          return ListTile(
            ...
            title: Text("Booking ID: ${transaction.relatedBookingId}",
